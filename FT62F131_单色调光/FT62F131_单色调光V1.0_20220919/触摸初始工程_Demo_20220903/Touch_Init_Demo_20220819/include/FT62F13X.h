...
// bit and bitfield definitions
// Register: SECCODE
volatile unsigned char           SECCODE      @ 0x0181;
// bit and bitfield definitions
...
#ifdef	_FT62FC3X
// Register: ADCON4
volatile unsigned char           ADCON4       @ 0x0189;
// bit and bitfield definitions
volatile bit CHPCF0                @ ((unsigned)&ADCON4*8)+0;
volatile bit CHPCF1                @ ((unsigned)&ADCON4*8)+1;
volatile bit CHPCKS                @ ((unsigned)&ADCON4*8)+2;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	CHPCF0              : 1;
...
#endif
// Register: CHIPVER
volatile unsigned char           CHIPVER       @ 0x018F;
// bit and bitfield definitions
volatile bit CHIPVER0                @ ((unsigned)&CHIPVER*8)+0;
volatile bit CHIPVER1                @ ((unsigned)&CHIPVER*8)+1;
volatile bit CHIPVER2                @ ((unsigned)&CHIPVER*8)+2;
volatile bit CHIPVER3                @ ((unsigned)&CHIPVER*8)+3;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	CHIPVER0              : 1;
...
#endif
// Register: TKCON2
volatile unsigned char           TKCON2       @ 0x0190;
// bit and bitfield definitions
volatile bit TKAUXTC                @ ((unsigned)&TKCON2*8)+0;
volatile bit TKAUXTE                @ ((unsigned)&TKCON2*8)+1;
volatile bit TKPWMTS                @ ((unsigned)&TKCON2*8)+2;
volatile bit TKMATS                 @ ((unsigned)&TKCON2*8)+3;
volatile bit TKIOMOD                @ ((unsigned)&TKCON2*8)+4;
volatile bit TKAON                  @ ((unsigned)&TKCON2*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	TKAUXTC              : 1;
...
#ifdef	_FT62FC3X
volatile bit TKPWMCF                @ ((unsigned)&LVDTRIM*8)+7;
#endif
#ifndef _LIB_BUILD
volatile union {
    struct {
