...
#ifdef _FT61FC4X
//{ _T("ADCON4"),0x420,0,{_T("-"),_T("-"),_T("-"),_T("-"),_T("-"),_T("-"),_T("CHPCKS"),_T("CHPCF")} },//FT61FC4 专有
// Register: ADCON4
volatile unsigned char           ADCON4               @ 0x420;
// bit and bitfield definitions
volatile bit CHPCF                 @ ((unsigned)&ADCON4*8)+0;
volatile bit CHPCKS                @ ((unsigned)&ADCON4*8)+1;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	CHPCF              : 1;
...
#endif
//{ _T("CHIPVER"),0xF9F,0,{_T("-"),_T("-"),_T("-"),_T("-"),_T("CHIPVER3"),_T("CHIPVER2"),_T("CHIPVER1"),_T("CHIPVER0")} },//FT61FC4 专有// Register: ADCON4
volatile unsigned char           CHIPVER               @ 0xF9F;
// bit and bitfield definitions
