...
#include <intrins.h>
/*********************************************************************************************************************
	本例程设置PWM0、PWM1、PWM2、PWM3输出频率为30KHZ、占空比50%的PWM信号
...
// 	PWMCON = TIE(0) | ZIE(0) | PIE(0) | NIE(0) | MS(0) | CKS_PLL ;		//设置PWM时钟源为PLL  
	...
	PWMDUTL	= (unsigned char)(PWMDUT_V);	
/*********************************************************************************************************************/	
	P35F = P35_PWM2_SETTING;								//设置P35为PWM引脚功能
	P34F = P34_PWM3_SETTING;								//设置P34为PWM引脚功能
...
/*********************************************************************************************************************/
 	...
 	PWMUPD = (1<<PWM_CH0)|(1<<PWM_CH1)|(1<<PWM_CH2)|(1<<PWM_CH3);		//PWMDIV、PWMDUT更新使能
	while(PWMUPD);														//等待更新完成
 	PWMEN = (1<<PWM_CH0)|(1<<PWM_CH1)|(1<<PWM_CH2)|(1<<PWM_CH3);		//PWM0、PWM1、PWM2、PWM3使能
